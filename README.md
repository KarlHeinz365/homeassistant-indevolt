...
- **Extended Sensor.py with about ~230 sensors/entities total (Only sensor for main unit are enabled by default. Uncomment entries according the present expansion units.)**
